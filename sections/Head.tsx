...
export default function HeadComponent({
  ...
  return (
    <Head>
      ...
      />
      <link
        href="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@600&family=Montserrat:wght@600;700&family=Poppins:wght@500;700&family=Space+Grotesk:wght@400;500;600;700&display=swap"
        rel="stylesheet"
      />
