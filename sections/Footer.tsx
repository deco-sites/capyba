...
export default function Footer({
  ...
  return (
    <div class="h-screen flex items-end p-0 bg-footer">
      <div class="w-full h-auto max-w-[1296px] text-left mx-auto px-[24px] block relative mb-[10%] sm:mb-[2%]">
        <div class="h-auto grid-footer grid-cols-footerMobile sm:grid-cols-footerDesk">
          ...
          <div>
            <h2
              class="mb-6 text-right text-white font-sans text-[34px] sm:text-[54px] leading-[38px] sm:leading-[55px]"
        ...
        <div class="flex flex-wrap sm:h-auto sm:grid-footer-second">
          <div class="order-last sm:order-none mx-auto sm:mx-0 pt-[56px] sm:pt-0 px-[10px] sm:px-0 text-center sm:text-left text-xs sm:text-base font-sans font-bold text-subcolor self-end">
            {copyright}{" "}
